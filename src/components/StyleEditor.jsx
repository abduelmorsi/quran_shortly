...
import { Palette, Layout, Type, Upload, Film, Eye, Sparkles, ChevronDown } from 'lucide-react';
...
export default function StyleEditor({ styleConfig, onChange, onCustomBgUploaded, t }) {
  ...
  return (
    <div className="glass-panel styles-panel">
      ...
      {/* ACCORDION 1: Layout & Placement */}
      <div className={`accordion-card ${activeAccordion === 'layout' ? 'open' : ''}`}>
        <button className="accordion-header" onClick={() => toggleAccordion('layout')} type="button">
          <div className="accordion-header-title">
            <Layout size={18} style={{ color: 'var(--primary)' }} />
            <span>{t.layoutAccordionTitle}</span>
          </div>
      ...
      {/* ACCORDION 2: Background & Atmosphere */}
      <div className={`accordion-card ${activeAccordion === 'background' ? 'open' : ''}`}>
        <button className="accordion-header" onClick={() => toggleAccordion('background')} type="button">
          <div className="accordion-header-title">
            <Film size={18} style={{ color: 'var(--secondary)' }} />
            <span>{t.backgroundAccordionTitle}</span>
          </div>
          <ChevronDown size={18} className="accordion-chevron" />
        </button>
        <div className="accordion-content">
      ...
      {/* ACCORDION 3: Typography & Styling */}
      <div className={`accordion-card ${activeAccordion === 'typography' ? 'open' : ''}`}>
        <button className="accordion-header" onClick={() => toggleAccordion('typography')} type="button">
          <div className="accordion-header-title">
            <Type size={18} style={{ color: 'var(--accent)' }} />
            <span>{t.typographyAccordionTitle}</span>
          </div>
          <ChevronDown size={18} className="accordion-chevron" />
        </button>
        <div className="accordion-content">
